...
namespace Constants {
	...
	extern const char yqt[64] = {
		16, 12, 11, 12, 10, 14, 16, 19, 24, 26, 40, 58, 51 ,60, 61, 55,
		14, 14, 13, 17, 16, 22, 24, 29, 40, 51, 57, 87, 69, 80, 56, 62,
		18, 24, 22, 35, 37, 55, 56, 64, 68, 81, 109, 104, 103, 113, 77, 92,
		49, 72, 64, 92, 78, 95, 87, 98, 103, 112, 121, 100, 120, 103, 101, 99
	};

	extern const char cqt[16] = {
		17, 18, 24, 47, 99, 99, 99, 99,
		18, 21, 26, 66, 99, 99, 99, 99
	};
	extern const unsigned short coef_max_Range[16] = {
	0, 1, 3, 7, 15, 31, 63, 127, 255, 511, 1023, 2047, 4095, 8191, 16383, 32767
	};
	extern const unsigned short coef_min_Range[16] = {
	0, 1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192, 16384
	};
	extern const unsigned int DC_basecode[12] = {
	0x02, 0x06, 0x10, 0x00, 0x50, 0xC0, 0x0380, 0x0F00, 0x3E00, 0xFC00, 0x03F800, 0x0FF000
	};
	extern const char DC_length[12] = {
	3, 4, 5, 5, 7, 8, 10, 12, 14, 16, 18, 20
	};
	extern const unsigned int AC_basecode[16][11] = {
	...
	extern const char AC_length[16][11] = {
	...
	extern int idx = 0;
	extern int DC_shift = 0;
	extern int Bwidth = 0;
	extern int Bheight = 0;
	extern int Level = 0;// DCT에서는 안쓰임
